			...
			<div class="container">
				<div class="row">
					<div class="col-md-10 col-md-offset-1 animate-box">
						...
						$sql2 = "SELECT * FROM restaurant WHERE rest_id='$restid'";
						$result2 = mysqli_query($con,$sql2);
                        $row2 = mysqli_fetch_array($result2,MYSQLI_ASSOC);

						echo "<h2>You are about to cancel your booking at: ".$row2['rest_name']."</h2>";
						echo "<h2>On ".$row['book_date']."</h2>";
						...
						<!-- 
							...
							<div class="row form-group">
								<div class="col-md-12">
									<label for="message">Cancel Reason</label>
