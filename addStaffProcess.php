<?php
  ...
  if($email == "" || $password == "" || $restaurant == ""){
    ...
    if(mysqli_num_rows($exist_restaurant) != 0){
    	...
    	mysqli_query($con, "INSERT INTO user(user_email, user_fname, user_lname, user_type, rest_id, user_password) VALUES('$email', '$restaurant', 'staff', '$usertype', '$rest_id', '$user_password')");
