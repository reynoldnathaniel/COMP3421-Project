							...
							<div class="wrap-division">
								<div class="col-md-6 col-sm-6 animate-box">
									<div class="hotel-entry">
										<a href="hotel-room.html" class="hotel-img" style="background-image: url(images/enoteca-4.jpg);">
											
										</a>
										<div class="desc">
											<p class="star"><span><i class="icon-star-full"></i></span> 4.5/5.0</p>
											<h3><a href="hotel-room.html">ENOTECA</a></h3>
											<span class="place">G/F, 47 Elgin Street SoHo, Central, Hong Kong</span>
